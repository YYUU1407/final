...
author: |
  | Yara Yachnyk
  | y.yachnyk@students.uu.nl
  | http://www.github.com/YYUU1407
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
GrowthSW$treat <-
  ifelse(GrowthSW$revolutions == 0, 'Revolutions=0', 'Revolutions>0')
...
In the table created from the code above it is visible that the growth of countries with no revolutions have a higher growth, this is depicted by the mean and median being 2.46 and 2.29 compared to the 1.68 and 1.92 of countries with more than 0 revolutions. 
